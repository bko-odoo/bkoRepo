...
class Course(models.Model):
    ...
    responsible_name = fields.Char('Responsible', related='responsible_id.name')
...
class Session(models.Model):
    ...
    course_name = fields.Char('Course Name',related='course_id.name')
...
class Instructor(models.Model):
    ...
    instructor=fields.Boolean(string="Instructor",default=False,stored=True)
    session_ids = fields.One2many('openacademy.session','id', string='Sessions',ondelete='cascade')